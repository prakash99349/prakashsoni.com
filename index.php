...
<head>
	...
	<title>Prakash K. Soni - Personal Portfolio & Resume</title>
	<meta name="description" content="Prakash - Personal Portfolio & Resume">
...
<div class="site-wrapper">
	...
	<div class="mobile-header py-2 px-3 mt-4">
		...
		<a href="index.html" class="logo"><img src="https://via.placeholder.com/70x70" alt="Prakash K. Soni" /></a>
		<a href="index.html" class="site-title dot ml-2">Prakash K. Soni</a>
	</div>
	...
	<header class="left float-left shadow-dark" id="header">
		...
		<div class="header-inner d-flex align-items-start flex-column">
			<a href="index.html"><img src="https://via.placeholder.com/70x70" alt="Prakash K. Soni" /></a>
			<a href="index.html" class="site-title dot mt-3">Prakash K. Soni</a>
			...
			<div class="footer mt-auto">
				...
				<ul class="social-icons list-inline">
					<li class="list-inline-item"><a href="https://fb.com/pksony"><i class="fab fa-facebook-f"></i></a></li>
					<li class="list-inline-item"><a href="https://twitter.com/prakashsoniDAE"><i class="fab fa-twitter"></i></a></li>
					<li class="list-inline-item"><a href="https://www.instagram.com/prakashsonidae/"><i class="fab fa-instagram"></i></a></li>
					<li class="list-inline-item"><a href="https://youtube.com"><i class="fab fa-youtube"></i></a></li>
					<li class="list-inline-item"><a href="https://www.linkedin.com/in/prakashsonidae/"><i class="fab fa-linkdin"></i></a></li>
				</ul>

				<!-- copyright -->
				<span class="copyright">© 2022 Prakash Soni</span>
			</div>
		</div>
	</header>
	...
	<main class="content float-right">
		...
		<section class="hero background parallax shadow-dark d-flex align-items-center" id="home" data-image-src="https://via.placeholder.com/900x600">
			<div class="cta mx-auto mt-2">
				<h1 class="mt-0 mb-4">I’m Prakash K. Soni<span class="dot"></span></h1>
				<p class="mb-4">Let's Boost Businesses With Digital World, Promoting Highly Optimised Web Site On Search (Organic or Paid), Social (Organic or Paid) & Native Platform with Best PPC Ads Expert.</p>
		...
		<section id="about" class="shadow-blue white-bg padding">
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="mb-0">I am Prakash K. Soni, PPC ads Expert, Web & App developer from India. I have rich experience in PPC ads Management & Optimisation, also I am good at Web & App Development.</p>
					<div class="row my-4">
						<div class="col-md-6">
							<p class="mb-2">Name: <span class="text-dark">Prakash K. Soni</span></p>
							<p class="mb-0">Birthday: <span class="text-dark">10 April, 1991</span></p>
						</div>
						<div class="col-md-6 mt-2 mt-md-0 mt-sm-2">
							<p class="mb-2">Location: <span class="text-dark">India</span></p>
							<p class="mb-0">Email: <span class="text-dark">Mail@prakashsoni.com</span></p>
						</div>
					</div>
		...
		<section id="skills" class="shadow-blue white-bg padding">
			...
			<p class="mb-0">I have extensive experience in digital marketing, including search ads and other paid ads, as well as search engine optimization (SEO) and web development. I have a strong understanding of audience targeting, keyword research, and ad copy optimization for platforms such as Google Ads, Facebook Ads, and LinkedIn Ads. I am also skilled in SEO techniques, including keyword research, on-page optimization, and technical SEO, and have worked with tools such as Google Analytics and SEMrush. In addition, I have experience with web development technologies such as HTML, CSS, and JavaScript, and have created and maintained websites for small businesses and organizations.</p>
			...
			<div class="row mt-5">
				...
				<div class="col-md-6">
					...
					<div class="skill-item">
						<div class="skill-info clearfix">
							<h4 class="float-left mb-3 mt-0">Web & App Development</h4>
				...
				<div class="col-md-6">
					...
					<div class="skill-item">
						<div class="skill-info clearfix">
							<h4 class="float-left mb-3 mt-0">SEO & Paid Ads</h4>
				...
				<div class="col-md-6">
					...
					<div class="skill-item">
						<div class="skill-info clearfix">
							<h4 class="float-left mb-3 mt-0">Bussiness & Marketing</h4>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="service-item text-center">
						...
						<p class="mb-0">Revolutionizing Development: Innovative Strategies for Building Better Products and Services.</p>
					</div>
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="service-item text-center">
						...
						<p class="mb-0">The Art and Science of Design: Creating Compelling and User-Friendly Experiences.</p>
					</div>
					<div class="spacer" data-height="20"></div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="service-item text-center">
						...
						<p class="mb-0">Maximizing ROI through Strategic Advertising and Marketing Tactics.</p>
					</div>
					<div class="spacer" data-height="20"></div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="service-item text-center">
						...
						<p class="mb-0">Unlocking Online Success with SEO Strategies and Best Practices.</p>
					</div>
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="service-item text-center">
						...
						<p class="mb-0">Crafting Compelling Content: Copywriting Tips and Techniques for Success.</p>
					</div>
					<div class="spacer d-md-none d-lg-none" data-height="20"></div>
				</div>
				...
				<div class="col-md-4 col-sm-6">
					...
					<div class="service-item text-center">
						...
						<p class="mb-0">Providing Exceptional Support: Meeting Customer Needs with Care and Efficiency.</p>
					</div>
				</div>
				...
				<div class="col-md-4">
					...
					<div class="blog-item">
						...
						<ul class="list-inline meta mb-0 mt-3">
							...
							<li class="list-inline-item">Prakash K. Soni</li>
						</ul>
					</div>
				</div>
